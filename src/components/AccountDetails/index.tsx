...
export default function AccountDetails({
  ...
  const accountNewAddress = hexAddress2NewAddress(account, chainId)
                ...
                <AccountControl>
                  {ENSName ? (
                    ...
                    <>
                      <div>
                        {getStatusIcon()}
                        <p> {account && shortenAddress(accountNewAddress)}</p>
                      </div>
                    </>
                  )}
                </AccountControl>
                    ...
                    <AccountControl>
                      <div>
                        ...
                        {chainId && account && (
                          ...
                          >
                            <LinkIcon size={16} />
                            <span style={{ marginLeft: '4px' }}>{t('View on NewtonExplorer')}</span>
                          </AddressLink>
                        )}
                      </div>
                    </AccountControl>
